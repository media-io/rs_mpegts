...
pub fn write(afe: &AdaptationFieldExtension) -> Vec<u8> {
    let mut data = Vec::new();
    {
        ...
        afe_writer
            .write_bit(afe.legal_time_window.is_some())
            .unwrap();
        ...
        match afe.seamless_splice {
            ...
            Some(ref seamless_splice) => {
                afe_writer
                    .write(4, (*seamless_splice & (0xF << 33)) >> 33)
                    .unwrap();
                afe_writer
                    .write(3, (*seamless_splice & (0b111 << 30)) >> 30)
                    .unwrap();
                afe_writer.write_bit(true).unwrap();
                afe_writer
                    .write(15, (*seamless_splice & (0x7FFF << 15)) >> 15)
                    .unwrap();
                afe_writer.write_bit(true).unwrap();
...
pub fn write_adaptation_field_extension(
